...
@torch.jit.ignore
def compute_mask(D: int, H: int, W: int, window_size: Tuple[int, int, int], shift_size: Tuple[int, int, int], device) -> torch.Tensor:
    """ Compute attention mask for input of size (D, H, W). Cached in legacy via lru_cache."""
